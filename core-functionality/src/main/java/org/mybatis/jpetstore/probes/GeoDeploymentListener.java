 ...
 *
 */
public class GeoDeploymentListener implements ServletContextListener {
    ...
    public void contextInitialized(final ServletContextEvent event) {
        if (this.monitoringCtrl.isMonitoringEnabled()) {
            ...
            final String signature = service + ":" + context;
            
            if (this.monitoringCtrl.isProbeActivated(signature)) {
            	final String deploymentId = servletContext.getInitParameter(GeoDeploymentListener.DEPLOYMENT_ID);
